...
from hummingbot.data_feed.candles_feed.ascend_ex_spot_candles.ascend_ex_spot_candles import (
    AscendExSpotCandles,
)
from hummingbot.data_feed.candles_feed.binance_perpetual_candles import (
...
from hummingbot.data_feed.candles_feed.bybit_spot_candles.bybit_spot_candles import (
    BybitSpotCandles,
)
from hummingbot.data_feed.candles_feed.candles_base import CandlesBase
from hummingbot.data_feed.candles_feed.data_types import CandlesConfig
from hummingbot.data_feed.candles_feed.gate_io_perpetual_candles import (
    GateioPerpetualCandles,
)
...
from hummingbot.data_feed.candles_feed.hyperliquid_spot_candles.hyperliquid_spot_candles import (
    HyperliquidSpotCandles,
)
from hummingbot.data_feed.candles_feed.kraken_spot_candles.kraken_spot_candles import (
    KrakenSpotCandles,
)
from hummingbot.data_feed.candles_feed.kucoin_perpetual_candles.kucoin_perpetual_candles import (
    KucoinPerpetualCandles,
)
from hummingbot.data_feed.candles_feed.kucoin_spot_candles.kucoin_spot_candles import (
    KucoinSpotCandles,
)
from hummingbot.data_feed.candles_feed.mexc_perpetual_candles.mexc_perpetual_candles import (
    MexcPerpetualCandles,
)
from hummingbot.data_feed.candles_feed.mexc_spot_candles.mexc_spot_candles import (
    MexcSpotCandles,
)
from hummingbot.data_feed.candles_feed.okx_perpetual_candles.okx_perpetual_candles import (
    OKXPerpetualCandles,
)
from hummingbot.data_feed.candles_feed.okx_spot_candles.okx_spot_candles import (
    OKXSpotCandles,
)
...
class UnsupportedConnectorException(Exception):
    ...
    def __init__(self, connector: str):
        message = (
            f"The connector {connector} is not available. Please select another one."
        )
