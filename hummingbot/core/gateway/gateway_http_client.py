...
class GatewayHttpClient:
    ...
    @classmethod
    def _http_client(
        cls, client_config_map: "ClientConfigAdapter", re_init: bool = False
    ...
    def log_error_codes(self, resp: Dict[str, Any]):
        ...
        error_code: Optional[int] = (
            resp.get("errorCode") if isinstance(resp, dict) else None
        )
        if error_code is not None:
            if error_code == GatewayError.Network.value:
                ...
                self.logger().network(
                    "Gateway was unable to communicate with the node because of rate limiting."
                )
            elif error_code == GatewayError.OutOfGas.value:
                self.logger().network(
                    "There was an out of gas error. Adjust the gas limit in the gateway config."
                )
                ...
                self.logger().network(
                    "Some values was uninitialized. Please contact dev@hummingbot.io "
                )
                ...
                self.logger().network(
                    "An unknown error has occurred on gateway. Please send your logs to dev@hummingbot.io"
                )
        ...
        try:
            ...
            if not fail_silently and response.status == 504:
                ...
                if (
                    ...
                    and not self.is_timeout_error(parsed_response)
                ):
                    self.log_error_codes(parsed_response)

                    if "error" in parsed_response:
                        raise ValueError(
                            f"Error on {method.upper()} {url} Error: {parsed_response['error']}"
                        )
                    else:
                        raise ValueError(
                            f"Error on {method.upper()} {url} Error: {parsed_response}"
                        )
    ...
    async def update_config(
        self, config_path: str, config_value: Any
    ) -> Dict[str, Any]:
        ...
        self.logger().info(
            "Detected change to Gateway config - restarting Gateway...", exc_info=False
        )
    ...
    async def add_wallet(
        ...
        return await self.api_request(
            method="post", path_url="wallet/add", params=request
        )

    async def get_configuration(self, fail_silently: bool = False) -> Dict[str, Any]:
        return await self.api_request(
            "get", "solana/config", fail_silently=fail_silently
        )
    ...
    async def get_balances(
        ...
        if isinstance(token_symbols, list):
            token_symbols = [
                x for x in token_symbols if isinstance(x, str) and x.strip() != ""
            ]
            request_params = {
                "chain": chain,
                "network": network,
    ...
    async def get_tokens(
        self, chain: str, network: str, fail_silently: bool = True
    ) -> Dict[str, Any]:
        return await self.api_request(
            "get",
            "solana/tokens",
    ...
    async def get_algorand_assets(
        self, network: str, fail_silently: bool = True
    ) -> Dict[str, Any]:
        return await self.get_tokens(
            **{"chain": "algorand", "network": network, "fail_silently": fail_silently}
        )
    ...
    async def get_network_status(
        ...
        return await self.api_request(
            "get", "solana/status", req_data, fail_silently=fail_silently
        )
    ...
    async def approve_token(
        ...
        return await self.api_request("post", "chain/approve", request_payload)
    ...
    async def get_transaction_status(
        ...
        request = {"chain": chain, "network": network, "txHash": transaction_hash}
        if connector:
            request["connector"] = connector
        if address:
            request["address"] = address
        return await self.api_request(
            "post", "chain/poll", request, fail_silently=fail_silently
        )  # type: ignore
    ...
    async def get_evm_nonce(
        self, chain: str, network: str, address: str, fail_silently: bool = False
    ) -> Dict[str, Any]:
        return await self.api_request(
            "post",
            "chain/nextNonce",
    ...
    async def cancel_evm_transaction(
        self, chain: str, network: str, address: str, nonce: int
    ) -> Dict[str, Any]:
        return await self.api_request(
            "post",
            "chain/cancel",
            {"chain": chain, "network": network, "address": address, "nonce": nonce},
        )
    ...
    async def get_perp_markets(
        self, chain: str, network: str, connector: str, fail_silently: bool = False
    ) -> Dict[str, Any]:
        return await self.api_request(
            "post",
            "amm/perp/pairs",
    ...
    async def amm_lp_collect_fees(
        ...
        if max_priority_fee_per_gas is not None:
            request_payload["maxPriorityFeePerGas"] = str(max_priority_fee_per_gas)
        return await self.api_request(
            "post", "amm/liquidity/collect_fees", request_payload
        )
    ...
    async def clob_place_order(
        ...
        resp = await self.api_request(
            method="post", path_url="clob/orders", params=request_payload
        )
        return resp
    ...
    async def clob_cancel_order(
        ...
        resp = await self.api_request(
            method="delete", path_url="clob/orders", params=request_payload
        )
        return resp
    ...
    async def get_clob_order_status_updates(
        ...
        resp = await self.api_request(
            method="get", path_url="clob/orders", params=request_payload
        )
        return resp
    ...
    async def get_clob_markets(
        ...
        resp = await self.api_request(
            method="get", path_url="clob/markets", params=request_payload
        )
        return resp
    ...
    async def get_clob_orderbook_snapshot(
        ...
        resp = await self.api_request(
            method="get", path_url="clob/orderBook", params=request_payload
        )
        return resp
    ...
    async def get_clob_ticker(
        ...
        if trading_pair is not None:
            request_payload["market"] = trading_pair
        resp = await self.api_request(
            method="get", path_url="clob/ticker", params=request_payload
        )
        return resp
    ...
    async def clob_injective_balances(self, chain: str, network: str, address: str):
        request_payload = {
            "chain": chain,
            "network": network,
            "address": address,
    ...
    async def clob_perp_funding_info(
        self, chain: str, network: str, connector: str, trading_pair: str
    ) -> Dict[str, Any]:
        request_payload = {
            "chain": chain,
            "network": network,
        ...
        return await self.api_request(
            "post", "clob/perp/funding/info", request_payload, use_body=True
        )
    ...
    async def clob_perp_funding_payments(
        ...
        **kwargs,
        ...
        return await self.api_request(
            "post", "clob/perp/funding/payments", request_payload, use_body=True
        )
    ...
    async def clob_perp_positions(
        ...
        return await self.api_request(
            "post", "clob/perp/positions", request_payload, use_body=True
        )
    ...
    async def clob_perp_last_trade_price(
        ...
        return await self.api_request(
            "get", "clob/perp/lastTradePrice", request_payload
        )
    ...
    async def clob_perp_place_order(
        ...
        return await self.api_request(
            "post", "clob/perp/orders", request_payload, use_body=True
        )
    ...
    async def clob_perp_cancel_order(
        ...
        return await self.api_request(
            "delete", "clob/perp/orders", request_payload, use_body=True
        )
